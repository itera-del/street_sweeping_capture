...
def dataset_csv(args):
    ...
    for idx in tqdm(range(len(img_list))):
        ...
        for cell in data_json['shapes']:
            ...
            bool_plate_type = bool(re.match(r'^\d\d\d\d\d\d$', plate_num))

            if bool_error_plate or not (bool_plate_type):
            ...
            csv_list.append({"img_path": img_path, "json_path": json_path, "id": plate_id, "name": plate_name, "roi": plate_roi, "num": str(plate_num)})
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir', type=str, default="/yuanhuan/data/image/RM_HUANWEI/original/Argentina/Argentina/") 
    parser.add_argument('--output_csv_dir', type=str, default="/yuanhuan/data/image/RM_HUANWEI/original/Argentina/Argentina_csv/") 
    parser.add_argument('--output_crop_data_dir', type=str, default="/yuanhuan/data/image/RM_HUANWEI/original/Argentina/Argentina_crop/") 
    parser.add_argument('--output_error_data_dir', type=str, default="/yuanhuan/data/image/RM_HUANWEI/original/Argentina/Argentina_error_data/") 
