...
def split(args):
    ...
    csv_pd.to_csv(args.input_csv_path, columns=["img_path", "json_path", "roi_img_path", "id", "name", "roi", "num", "split_type"], index=False, encoding="utf_8_sig")
