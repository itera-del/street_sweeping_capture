#!/bin/bash
data_closed_dir=/yuanhuan/data/mhr/dataset_closed_loop/frames/mexican
data_dir=/yuanhuan/data/image/RM_MEXICAN/original/Argentina/Argentina
data_csv_dir=/yuanhuan/data/image/RM_MEXICAN/original/Argentina/Argentina_csv/
data_crop_dir=/yuanhuan/data/image/RM_MEXICAN/original/Argentina/Argentina_crop/
error_data_dir=/yuanhuan/data/image/RM_MEXICAN/original/Argentina/Argentina_error_data/
analysis_dir=/yuanhuan/data/image/RM_MEXICAN/original/Argentina/Argentina_analysis/
data_diffste_dir=

ocr_name=plate_mexican_20260407
training_data_dir=/yuanhuan/data/image/RM_MEXICAN/training_ocr/

# --date_name = Mexican_20260331_frames_5f
# 数据闭环系统（抽帧、去重、标注）
# bash /yuanhuan/code/demo/Image/dataset_closed_loop/dataset_project/data_closing_mexican.sh
...
# date_name_list=(Mexican_20260331)    # group_{date_name}_frames_5f
...
#     # python /yuanhuan/code/demo/Image/recognition2d/script/lpr/dataset/dataset_zd/dataset_move/data_move.py --input_dir=$data_closed_dir/${date_name}_frames_5f --output_dir=$data_dir/Argentina_${date_name} --jpg_subdir=batch_1 --xml_subdir=xml_mexican_det_v1.0_1_ocr
#     python /yuanhuan/code/demo/Image/Basic/script/xml/xml_to_platform_json_LPR_mexican.py --input_dir=$data_dir/Argentina_${date_name}
...
# # todo
# # date_name_list=()
# date_name_list=(Mexican_20260331) 
# for date_name in ${date_name_list[@]}; do 
#     echo $date_name

#     # normal
#     python /yuanhuan/code/demo/Image/recognition2d/script/lpr/dataset/dataset_huanwei/dataset_check/dataset_csv_mexican.py --date_name=$date_name --input_dir=$data_dir --output_csv_dir=$data_csv_dir --output_crop_data_dir=$data_crop_dir --output_error_data_dir=$error_data_dir --bool_write_error_data
...
#     # ocr
#     python /yuanhuan/code/demo/Image/recognition2d/script/lpr/dataset/dataset_huanwei/dataset_mask/gen_ocr_img_mexican.py --date_name=$date_name --ocr_name=$ocr_name --input_csv_dir=$data_csv_dir --output_dir=$training_data_dir
#     python /yuanhuan/code/demo/Image/recognition2d/script/lpr/dataset/dataset_huanwei/dataset_train_test_split/data_train_test_split_ocr_mexican.py --date_name=$date_name --ocr_name=$ocr_name --input_dir=$training_data_dir

#     # ocr augment
#     python /yuanhuan/code/demo/Image/recognition2d/script/lpr/dataset/dataset_huanwei/dataset_mask/gen_ocr_img_augment_mexican.py --date_name=$date_name --ocr_name=$ocr_name --output_dir=$training_data_dir
...
paddle_ocr_data_dir=/yuanhuan/data/mhr/dataset_closed_loop/frames/mexican/Mexican_20260331_frames_5f/paddle_dict
