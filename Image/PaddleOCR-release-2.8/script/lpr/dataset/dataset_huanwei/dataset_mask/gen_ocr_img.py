...
def gen_ocr_img(args):
    ...
    # init 
    csv_list = []           # [{"img_path": "", "json_path": "", "roi_img_path": "", "id": "", "name": "", "roi": "", "num": ""}]
    ...
    for idx, row in tqdm(data_pd.iterrows(), total=len(data_pd)):
        ...
        try:
            ...
            csv_list.append({"img_path": img_path, "json_path": json_path, "roi_img_path": output_img_path, "id": plate_id, "name": plate_name, "roi": plate_roi, "num": plate_num})
        except:
            continue
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_csv_dir', type=str, default="/yuanhuan/data/image/RM_HUANWEI/original/Argentina/Argentina_csv/") 
