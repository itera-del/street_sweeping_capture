...
#     # 运行脚本 dataset_select/dataset_group_mexican.py，数据分组，按照车牌长度和字符分组 
#     python /yuanhuan/code/demo/Image/sd/script/diffste/dataset_plate/dataset_select/dataset_group_mexican.py --date_name=${date_name} --ocr_name=$ocr_name --input_dir=$training_data_dir
# done
