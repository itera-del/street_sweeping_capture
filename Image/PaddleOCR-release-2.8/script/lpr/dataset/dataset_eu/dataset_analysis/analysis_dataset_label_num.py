...
if __name__ == "__main__":
    ...
    parser.add_argument('--date_name', type=str, default="turkey_20230907") 
    parser.add_argument('--input_csv_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/eu/eu_csv/") 
    parser.add_argument('--output_analysis_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/eu/eu_analysis/") 
