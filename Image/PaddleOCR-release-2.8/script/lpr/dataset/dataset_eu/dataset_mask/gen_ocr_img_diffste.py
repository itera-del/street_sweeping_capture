...
if __name__ == "__main__":
    ...
    parser.add_argument('--date_name', type=str, default="diffste_turkey_2021_2023_scale_padding")
    parser.add_argument('--ocr_name', type=str, default="plate_eu_202403")
    parser.add_argument('--input_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/eu/DIFFSTE/")
