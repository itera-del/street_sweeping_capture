...
def gen_ocr_img(args):
    ...
    for idx, row in tqdm(data_pd.iterrows(), total=len(data_pd)):
        ...
        if plate_column != args.plate_column:
            print(img_path, plate_name, plate_column)
            continue
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ocr_name', type=str, default="plate_eu_202401") 
    ...
    parser.add_argument('--plate_column', type=str, default="single") 
