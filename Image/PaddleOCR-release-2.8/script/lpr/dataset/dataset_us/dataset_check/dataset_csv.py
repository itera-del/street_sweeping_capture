...
from Image.recognition2d.script.lpr.dataset.dataset_us.dataset_dict.dataset_us_dict_normal import *
...
def dataset_csv(args):
    ...
    for idx in tqdm(range(len(img_list))):
        ...
        for cell in data_json['shapes']:
            ...
            # plate num check           
            bool_error_plate_num = np.array([True if str_num not in kind_num_labels[1:] else False for str_num in plate_num]).sum()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/us/us/") 
    parser.add_argument('--output_csv_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/us/us_csv/") 
    parser.add_argument('--output_crop_data_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/us/us_crop/") 
    parser.add_argument('--output_error_data_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/us/us_error_data/") 
