...
if __name__ == "__main__":
    ...
    args.ignore_list = [
                        ...
                        'ImageSetsOcrLabel', 
                        # 'Alabama_2022', 
                        'ImageSetsOcrLabelNoAug_Texas', 
                        'ImageSetsOcrLabel_Texas', 
                        ]
    ...
    args.merge_file_list = [
                            ...
                            "ImageSets/Main/all.txt",
                            "ImageSets/Main/all_threshold.txt",
                            ]
    ...
    # args.to_input_dir = os.path.join(args.input_dir, "ImageSetsOcrLabelNoAug_Texas")
    ...
    # args.to_input_dir = os.path.join(args.input_dir, "ImageSetsOcrLabel_Texas")
