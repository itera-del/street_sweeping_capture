...
if __name__ == "__main__":
    ...
    parser.add_argument('--date_name', type=str, default="diffste_Texas_665_scale_padding")
    parser.add_argument('--ocr_name', type=str, default="plate_us_202310")
    parser.add_argument('--input_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/us/DIFFSTE/")
