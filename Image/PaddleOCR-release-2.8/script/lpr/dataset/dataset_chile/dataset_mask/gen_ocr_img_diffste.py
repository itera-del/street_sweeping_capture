...
if __name__ == "__main__":
    ...
    parser.add_argument('--date_name', type=str, default="diffste_chile_20231202_20231203_scale_padding")
    parser.add_argument('--ocr_name', type=str, default="plate_chile_202312")
    parser.add_argument('--input_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/Chile/DIFFSTE/")
