...
from Image.recognition2d.script.lpr.dataset.dataset_chile.dataset_dict.dataset_chile_dict_normal import *
...
def dataset_csv(args):
    ...
    for idx in tqdm(range(len(img_list))):
        ...
        for cell in data_json['shapes']:
            ...
            bool_plate_type_1 = bool(re.match(r'^[A-Z][A-Z]-[A-Z][A-Z]\^\d\d$', plate_num))
            # char char ^ num num - num num
            bool_plate_type_2 = bool(re.match(r'^[A-Z][A-Z]\^\d\d-\d\d$', plate_num))
            # char char char ^ num num num
            bool_plate_type_3 = bool(re.match(r'^[A-Z][A-Z][A-Z]\^\d\d\d$', plate_num))
            # char char char - num num
            bool_plate_type_4 = bool(re.match(r'^[A-Z][A-Z][A-Z]\-\d\d$', plate_num))
            if bool_error_plate or not (bool_plate_type_1 or bool_plate_type_2 or bool_plate_type_3 or bool_plate_type_4):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--date_name', type=str, default="chile_20231202_20231203") 
    parser.add_argument('--input_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/Chile/Chile/") 
    parser.add_argument('--output_csv_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/Chile/Chile_csv/") 
    parser.add_argument('--output_crop_data_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/Chile/Chile_crop/") 
    parser.add_argument('--output_error_data_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/Chile/Chile_error_data/") 
    ...
    args.error_plate_num_list = ['SJ-VX^52']
