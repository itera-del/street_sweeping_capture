...
def split(args):
    ...
    csv_pd.to_csv(args.input_csv_path, columns=["img_path", "json_path", "roi_img_path", "roi_mask_path", "id", "name", "roi", "color", "column", "num", "crop_img", "crop_xml", "crop_json", "split_type"], index=False, encoding="utf_8_sig")
