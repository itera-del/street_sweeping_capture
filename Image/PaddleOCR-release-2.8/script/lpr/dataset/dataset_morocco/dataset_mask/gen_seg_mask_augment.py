...
def gen_seg_mask_augument(args):
    ...
    # dataset_zd_dict
    # city
    dataset_city_dict = importlib.import_module('script.lpr.dataset.dataset_morocco.dataset_dict.' + args.seg_city_dict_name) 
...
if __name__ == "__main__":
    ...
    ###############################################
    # dataset_morocco_dict_city
    ###############################################
    
    args.seg_city_dict_name = "dataset_morocco_dict_city"
