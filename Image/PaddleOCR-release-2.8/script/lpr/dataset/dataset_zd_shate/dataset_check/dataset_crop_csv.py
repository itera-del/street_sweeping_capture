    ...
    for idx, row in tqdm(data_pd.iterrows(), total=len(data_pd)):
        ...
        for cell in data_json['shapes']:
            ...
            if "license_kind" == cell["label"]:
                ...
                # raise Exception
                print('"img_path": {}, "json_path": {}, "crop_img": {}, "crop_xml": {}, "crop_json": {}, "type": "color"'.format(img_path, json_path, crop_img_path, crop_xml_path, crop_json_path))
                error_list.append({"img_path": img_path, "json_path": json_path, "crop_img": crop_img_path, "crop_xml": crop_xml_path, "crop_json": crop_json_path, "type": "color", "value": cell["label"]})
        ...
        if num_id == "":
            ...
            if len(num_list) != 1:
                num_error_bool = True
            elif num_list[0]["attributes"][0]["value"] != num_id:
                num_error_bool = True
        ...
        csv_list.append({"img_path": img_path, "json_path": json_path, "id": plate_id, "name": plate_name, "roi": plate_roi, "country": plate_country, "color": plate_color, "column": plate_column, "num": plate_num, "crop_img": crop_img_path, "crop_xml": crop_xml_path, "crop_json": crop_json_path})
...
if __name__ == "__main__":
    ...
    parser.add_argument('--date_name', type=str, default="shate_20241230") 
    parser.add_argument('--input_csv_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/zd/Shate/Shate_csv/") 
    parser.add_argument('--input_crop_data_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/zd/Shate/Shate_crop/") 
    parser.add_argument('--output_csv_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/zd/Shate/Shate_crop_csv/") 
    parser.add_argument('--output_error_crop_data_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/zd/Shate/Shate_error_crop_data/") 
