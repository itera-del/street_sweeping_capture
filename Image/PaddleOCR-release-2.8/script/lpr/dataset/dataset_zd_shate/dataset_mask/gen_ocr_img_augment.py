...
from script.lpr.dataset.dataset_zd_shate.dataset_mask.gen_ocr_img import *

def gen_ocr_img_augument(args):

    # dataset_zd_dict
    dataset_dict = importlib.import_module('script.lpr.dataset.dataset_zd_shate.dataset_dict.' + args.data_dict_name) 
