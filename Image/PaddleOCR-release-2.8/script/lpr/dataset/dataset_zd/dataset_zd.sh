...
data_crop_scale_padding_dir=/yuanhuan/data/image/RM_ANPR/original/zd/UAE/UAE_crop_scale_padding
...
analysis_crop_dir=/yuanhuan/data/image/RM_ANPR/original/zd/UAE/UAE_analysis_crop/

diffste_name=diffste_1750_Dubai_AA_BB_CC_256_128
diffste_dir=/yuanhuan/data/image/RM_ANPR/original/zd/UAE/UAE_crop_scale_padding/DIFFSTE/

seg_name=seg_zd_202504
seg_lmdb_name=seg_zd_lmdb_202504
ocr_name=plate_zd_mask_202502
...
# #################################
# # done
# # date_name_list=(20241113)   # capture_zd_collect_${date_name}_frames_5f
# # date_name_list=(20241105 20241106 20241107 20241108)    # capture_zd_${date_name}_frames_5f
# # date_name_list=(20241111 20241112 20241113 20241114 20241115 20241118 20241119 20241120)    # capture_zd_${date_name}_frames_5f
# date_name_list=(20241107)    # capture_zd_${date_name}_frames_5f
...
#     # capture_zd_collect_${date_name}_frames_5f 20241113
#     # python /yuanhuan/code/demo/Image/recognition2d/script/lpr/dataset/dataset_zd/dataset_move/data_move.py --input_dir=$data_closed_dir/capture_zd_collect_${date_name}_frames_5f --output_dir=$data_dir/uae_collect_${date_name}
#     # python /yuanhuan/code/demo/Image/recognition2d/script/lpr/dataset/dataset_zd/dataset_move/data_flip.py --input_dir=$data_dir/uae_collect_${date_name}
#     # python /yuanhuan/code/demo/Image/Basic/script/xml/xml_to_platform_json_LPR.py --input_dir=$data_dir/uae_collect_${date_name}
    
#     # capture_zd_${date_name}_frames_5f 20241105 20241106 20241107 20241108
#     python /yuanhuan/code/demo/Image/recognition2d/script/lpr/dataset/dataset_zd/dataset_move/data_move.py --input_dir=$data_closed_dir/capture_zd_${date_name}_frames_5f --output_dir=$data_dir/uae_${date_name}
#     python /yuanhuan/code/demo/Image/recognition2d/script/lpr/dataset/dataset_zd/dataset_move/data_flip.py --input_dir=$data_dir/uae_${date_name}
#     python /yuanhuan/code/demo/Image/Basic/script/xml/xml_to_platform_json_LPR.py --input_dir=$data_dir/uae_${date_name}

#     # # capture_zd_${date_name}_frames_5f 20241111 20241112 20241113 20241114 20241115 20241118 20241119 20241120
#     # python /yuanhuan/code/demo/Image/recognition2d/script/lpr/dataset/dataset_zd/dataset_move/data_move.py --input_dir=$data_closed_dir/capture_zd_${date_name}_frames_5f --output_dir=$data_dir/uae_${date_name}
#     # python /yuanhuan/code/demo/Image/Basic/script/xml/xml_to_platform_json_LPR.py --input_dir=$data_dir/uae_${date_name}
...
# # date_name_list=(uae_collect_20241113 uae_20241105 uae_20241106 uae_20241107 uae_20241108 uae_20241111 uae_20241112 uae_20241113 uae_20241114 uae_20241115 uae_20241118 uae_20241119)
...
# # todo
# date_name_list=(uae_20241106 uae_20241107)
...
#     # old style 
#     python /yuanhuan/code/demo/Image/recognition2d/script/lpr/dataset/dataset_zd/dataset_check/dataset_crop_csv.py --date_name=$date_name --input_csv_dir=$data_csv_dir --input_crop_data_dir=$data_crop_dir --output_csv_dir=$data_crop_csv_dir --output_error_crop_data_dir=$error_crop_data_dir
...
#     # python /yuanhuan/code/demo/Image/recognition2d/script/lpr/dataset/dataset_zd/dataset_analysis/analysis_dataset_crop_label_num.py --date_name=$date_name --input_csv_dir=$data_crop_csv_dir --output_analysis_dir=$analysis_crop_dir
#     # # new style
...
#     python /yuanhuan/code/demo/Image/recognition2d/script/lpr/dataset/dataset_zd/dataset_analysis/analysis_dataset_crop_label_num.py --date_name=$date_name --input_csv_dir=$data_crop_csv_dir --output_analysis_dir=$analysis_crop_dir --new_style
...
# # old style
# # date_name_list=(uae_20220804_0809 uae_20220810_0811 uae_20220828_0831 uae_20220901_0903 uae_20220904_0905 uae_20221024_1029 uae_20221024_1029_1080p uae_20221115_1116 uae_20221115_1116_1080p uae_2022_0 uae_2022_1 uae_2022_2 uae_2022_3 uae_2022_4 uae_2022_5 uae_2022_6 uae_2022_7 uae_2022_8 uae_2022_city_AJMAN_0 uae_2022_city_FUJAIRAH_0 uae_2022_city_RAK_0 uae_2022_city_SHARJAH_0 uae_2022_city_UMMALQAIWAIN_0 uae_2022_color_green_0 uae_2022_color_yellow_0)
# # date_name_list=(uae_2022_old) # NoAug
# # new style
# # date_name_list=(shate_20230308 shate_20230309)
# # date_name_list=(uae_collect_20241113 uae_20241105 uae_20241106 uae_20241107 uae_20241108 uae_20241111 uae_20241112 uae_20241113 uae_20241114 uae_20241115 uae_20241118 uae_20241119)
# # done ocr seg res
# # date_name_list=(uae_20220804_0809 uae_20220810_0811 uae_20220828_0831 uae_20220901_0903 uae_20220904_0905 uae_20221024_1029 uae_20221024_1029_1080p uae_20221115_1116 uae_20221115_1116_1080p uae_2022_0 uae_2022_1 uae_2022_2 uae_2022_3 uae_2022_4 uae_2022_5 uae_2022_6 uae_2022_7 uae_2022_8 uae_2022_city_AJMAN_0 uae_2022_city_FUJAIRAH_0 uae_2022_city_RAK_0 uae_2022_city_SHARJAH_0 uae_2022_city_UMMALQAIWAIN_0 uae_2022_color_green_0 uae_2022_color_yellow_0 uae_collect_20241113 uae_20241105 uae_20241106 uae_20241107 uae_20241108 uae_20241111 uae_20241112 uae_20241113 uae_20241114 uae_20241115 uae_20241118 uae_20241119)
# # done ocr diffste
# date_name_list=(uae_collect_20241113 uae_20241105 uae_20241106 uae_20241107 uae_20241108 uae_20241111 uae_20241112 uae_20241113 uae_20241114 uae_20241115 uae_20241118 uae_20241119)
...
# #     # python /yuanhuan/code/demo/Image/recognition2d/script/lpr/dataset/dataset_zd/dataset_train_test_split/data_train_test_split_ocr.py --date_name=${date_name}_seg_res --ocr_name=$ocr_name --input_dir=$training_data_dir

# #     # ocr diffste
# #     # python /yuanhuan/code/demo/Image/recognition2d/script/lpr/dataset/dataset_zd/dataset_mask/gen_ocr_img_diffste.py --date_name=$date_name --seg_name=$seg_name --ocr_name=$ocr_name --output_dir=$training_data_dir --diffste_name $diffste_name --diffste_dir $diffste_dir
# # done
...
# #################################
# # 2 paddleocr label
# paddle_ocr_name=plate_zd_mask_20250408_NoAug
# image_set_name=ImageSetsOcrLabelNoAug
# # paddle_ocr_name=plate_zd_mask_20250408
...
# # todo
# date_name_list=(DIFFSTE/original_1750_Dubai_AA_BB_CC)
