...
if __name__ == "__main__":
    ...
    parser.add_argument('--date_name', type=str, default="uae_collect_20241113")
    parser.add_argument('--seg_name', type=str, default="seg_zd_202504")
    ...
    parser.add_argument('--diffste_name', type=str, default="diffste_1750_Dubai_AA_BB_CC_256_128") 
    parser.add_argument('--diffste_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/zd/UAE/UAE_crop_scale_padding/DIFFSTE/") 
