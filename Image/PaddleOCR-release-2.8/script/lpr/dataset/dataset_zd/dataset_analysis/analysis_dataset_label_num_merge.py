...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/zd/UAE/UAE_analysis/")
    parser.add_argument('--seg_dict_name', type=str, default="script.lpr.dataset.dataset_zd.dataset_dict.dataset_zd_dict_normal")
