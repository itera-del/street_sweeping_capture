...
if __name__ == "__main__":
    ...
    args.merge_dir_list = list(np.array(args.merge_dir_list)[["diffste" not in str(os.path.basename(dir)) for dir in args.merge_dir_list]])
    ###############################################
    ## no aug no diffste
    ###############################################
    args.label_name = ""
    args.bool_aug = False
    args.to_input_dir = os.path.join(args.input_dir, "ImageSetsOcrLabelNoAugNoDiffste")
