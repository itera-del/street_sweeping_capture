...
def split(args):
    ...
    csv_pd.to_csv(args.input_csv_path, columns=["img_path", "json_path", "roi_img_path", "roi_mask_path", "id", "name", "roi", "color", "column", "num", "split_type"], index=False, encoding="utf_8_sig")


if __name__ == "__main__":
    
    parser = argparse.ArgumentParser()
    parser.add_argument('--date_name', type=str, default="guangzhou_8mm_2024/20231214_20240123") 
    ...
    args.input_dir = os.path.join(args.input_dir, args.seg_name, date_name)
    args.input_csv_path = os.path.join(args.input_dir, 'color_label/{}.csv'.format(date_name))
