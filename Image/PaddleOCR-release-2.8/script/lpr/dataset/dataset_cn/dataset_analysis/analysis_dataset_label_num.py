...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_csv_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/cn_202406/china_csv/") 
    parser.add_argument('--output_analysis_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/cn_202406/china_analysis/") 
    ...
    args.output_analysis_dir = os.path.join(args.output_analysis_dir, date_name)
