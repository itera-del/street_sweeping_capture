        ...
        for cell in data_json['shapes']:
            ...
            try:
                ...
                if args.bool_check_img:
                    ...
                    cv2.imwrite(os.path.join(args.output_temp_data_img_dir, "temp.jpg"), plate_img)
            except:
            ...
            if not ((len(plate_num) == 7 and plate_color == color_name_list[4]) or \
                    (len(plate_num) == 7 and plate_color == color_name_list[3]) or \
                    (len(plate_num) == 7 and plate_color == color_name_list[5]) or \
                    ...
                    ((args.date_name == "Xianggang" or args.date_name == "Aomen") and (len(plate_num) in [3,4,5,6,7,8]) and (plate_color in [color_name_list[3], color_name_list[5], color_name_list[7]]))
                    ):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--date_name', type=str, default="Kehu3") 
    parser.add_argument('--input_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/cn_202406/china/") 
    parser.add_argument('--output_csv_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/cn_202406/china_csv/") 
    parser.add_argument('--output_crop_data_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/cn_202406/china_crop/") 
    parser.add_argument('--output_error_data_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/cn_202406/china_error_data/") 
    ...
    args.output_csv_path = os.path.join(args.output_csv_dir, date_name + '.csv')
    args.output_crop_data_dir = os.path.join(args.output_crop_data_dir, date_name)
    args.output_error_data_dir = os.path.join(args.output_error_data_dir, date_name)
    args.output_temp_data_img_dir = os.path.join(args.input_dir)
