...
def gen_ocr_img(args):
    ...
    for idx in tqdm(range(len(img_list))):
        ...
        if plate_num[0] in args.city_list:
            print(plate_num)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--date_name', type=str, default="diffste_248_111600") 
    parser.add_argument('--ocr_name', type=str, default="original_tianjin") 
    parser.add_argument('--input_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/cn/DIFFSTE/") 
    ...
    args.output_dir = os.path.join(args.output_dir, args.ocr_name, "JPEGImages_diffste")
