...
def gen_ocr_img(args):
    ...
    for idx in tqdm(range(len(img_list))):
        ...
        ignore_bool = False
        for plate_idx in range(len(plate_num)): 
            plate_num_idx = plate_num[plate_idx]
            if plate_num_idx in ignore_num:
                ignore_bool = True
        if ignore_bool:
            print("Ignore: ", img_path)
            continue
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ocr_name', type=str, default="plate_cn_diffste_202307") 
