        ...
        for idy in range(args.aug_times):
            ...
            try:
                ...
                if idy in [0, 1, 2]:
                    ...
                    while idz < 30:
                        # lyx 透视变换
                        rotate_img, rotate_img_roi, rotate_bool = aug_perspective_transformation_roi(img.copy(),plate_roi.copy())
                        if rotate_bool:
                            break
                        else:
                            idz += 1
                    if not rotate_bool:
                        print("[ERROR] aug_perspective_transformation_roi: {}".format(img_path))
                        continue
                ...
                if rotate_img_crop.shape[0]!=0 and rotate_img_crop.shape[1]!=0:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--date_name', type=str, default="Anhui")
    parser.add_argument('--ocr_name', type=str, default="plate_cn_202406")
