...
def gen_ocr_img(args):
    ...
    for idx, row in tqdm(data_pd.iterrows(), total=len(data_pd)):
        ...
        if plate_num[0] == args.city and plate_color in args.color_list and plate_column == args.column:
            print(plate_num)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--date_name', type=str, default="jilin") 
    parser.add_argument('--ocr_name', type=str, default="original_beijing") 
    parser.add_argument('--input_csv_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/cn/china_csv/") 
    parser.add_argument('--output_dir', type=str, default="/yuanhuan/data/image/RM_ANPR/original/cn/DIFFSTE/") 
    args = parser.parse_args()
    
    args.city = "京"
    args.column = "single"
    args.color_list = ['blue', 'green']
    ...
    args.output_dir = os.path.join(args.output_dir, args.ocr_name, "JPEGImages")
    ...
    args.output_csv_path = os.path.join(args.output_dir, '{}.csv'.format(date_name))
