...
if __name__ == "__main__":
    ...
    args.output_dir = os.path.join(args.output_dir, args.seg_name, date_name)
    ...
    args.input_csv_path = os.path.join(args.output_dir, 'color_label', date_name + '.csv')
    args.output_csv_path = os.path.join(args.output_dir, 'color_label', date_name + '_augument.csv')
