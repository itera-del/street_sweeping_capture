...
if __name__ == '__main__':
    ...
    # us
    ######################################
    # args.input_dir = "/yuanhuan/model/image/lpr/paddle_ocr/v1_us_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_128_256_202310_w_diffste_w_aug/"
    ...
    # us
    # args.input_csv_path = os.path.join(args.input_dir, 'inference/test_caffe/data_us_test_result.csv')
    # args.out_csv_path = os.path.join(args.input_dir, "inference/test_caffe/analysis_data_us_test_result.csv")
    # args.input_csv_path = os.path.join(args.input_dir, 'inference/test_caffe/data_us_trainval_result.csv')
    # args.out_csv_path = os.path.join(args.input_dir, "inference/test_caffe/analysis_data_us_trainval_result.csv")
    # args.input_csv_path = os.path.join(args.input_dir, 'inference/test_caffe/data_us_Alabama_all_result.csv')
    # args.out_csv_path = os.path.join(args.input_dir, "inference/test_caffe/analysis_data_us_Alabama_all_result.csv")
    # args.input_csv_path = os.path.join(args.input_dir, 'inference/test_caffe/data_us_Alabama_all_threshold_result.csv')
    # args.out_csv_path = os.path.join(args.input_dir, "inference/test_caffe/analysis_data_us_Alabama_all_threshold_result.csv")
    # args.input_csv_path = os.path.join(args.input_dir, 'inference/test_caffe/data_us_Texas_all_result.csv')
    # args.out_csv_path = os.path.join(args.input_dir, "inference/test_caffe/analysis_data_us_Texas_all_result.csv")
    args.input_csv_path = os.path.join(args.input_dir, 'inference/test_caffe/data_us_Texas_all_threshold_result.csv')
    args.out_csv_path = os.path.join(args.input_dir, "inference/test_caffe/analysis_data_us_Texas_all_threshold_result.csv")
    ...
    # # chile
    # ######################################
    # args.input_dir = "/yuanhuan/model/image/lpr/paddle_ocr/v1_chile_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_128_256_202312_w_diffste_w_aug"

    # # us
    # args.input_csv_path = os.path.join(args.input_dir, 'inference/test_caffe/data_chile_test_result.csv')
    # args.out_csv_path = os.path.join(args.input_dir, "inference/test_caffe/analysis_data_chile_test_result.csv")
    # # args.input_csv_path = os.path.join(args.input_dir, 'inference/test_caffe/data_chile_trainval_result.csv')
    # # args.out_csv_path = os.path.join(args.input_dir, "inference/test_caffe/analysis_data_chile_trainval_result.csv")
    # # args.input_csv_path = os.path.join(args.input_dir, 'inference/test_caffe/data_chile_wdiffste_test_result.csv')
    # # args.out_csv_path = os.path.join(args.input_dir, "inference/test_caffe/analysis_data_chile_wdiffste_test_result.csv")
    ...
    # # eu
    # ######################################
    # args.input_dir = "/yuanhuan/model/image/lpr/paddle_ocr/v1_eu_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20240321_w_diffste_w_aug"

    # # us
    # # args.input_csv_path = os.path.join(args.input_dir, 'inference/test_paddle/data_eu_trainval_result.csv')
    # # args.out_csv_path = os.path.join(args.input_dir, "inference/test_paddle/analysis_data_eu_trainval_result.csv")
    # # args.input_csv_path = os.path.join(args.input_dir, 'inference/test_paddle/data_eu_test_result.csv')
    # # args.out_csv_path = os.path.join(args.input_dir, "inference/test_paddle/analysis_data_eu_test_result.csv")
    # args.input_csv_path = os.path.join(args.input_dir, 'inference/test_caffe/data_eu_trainval_result.csv')
    # args.out_csv_path = os.path.join(args.input_dir, "inference/test_caffe/analysis_data_eu_trainval_result.csv")
    # # args.input_csv_path = os.path.join(args.input_dir, 'inference/test_caffe/data_eu_test_result.csv')
    # # args.out_csv_path = os.path.join(args.input_dir, "inference/test_caffe/analysis_data_eu_test_result.csv")
