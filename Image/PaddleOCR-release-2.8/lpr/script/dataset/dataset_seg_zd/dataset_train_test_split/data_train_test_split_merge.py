...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir', type=str, default="/yuanhuan/data/image/LicensePlate_ocr/training/seg_zd/") 
    args = parser.parse_args()
    
    print("5、data train test split merge.")
    print("input_dir: {}".format(args.input_dir))
    
    args.ignore_list = [
                        'ImageSetsCityLabelNoAug', 
                        'ImageSetsCityLabel',
                        'ImageSetsColorLabelNoAug',
                        'ImageSetsColorLabel',
                        'ImageSetsCityColorLabelNoAug',
                        'ImageSetsCityColorLabel',
                        ]
    ...
    args.bool_aug = False
    args.to_input_dir = os.path.join(args.input_dir, "ImageSetsCityLabelNoAug")
    ...
    args.label_name = "city_label"
    args.bool_aug = True
    args.to_input_dir = os.path.join(args.input_dir, "ImageSetsCityLabel")
    ...
    args.bool_aug = False
    args.to_input_dir = os.path.join(args.input_dir, "ImageSetsColorLabelNoAug")
    ...
    args.label_name = "color_label"
    args.bool_aug = True
    args.to_input_dir = os.path.join(args.input_dir, "ImageSetsColorLabel")
    ...
    args.bool_aug = False
    args.to_input_dir = os.path.join(args.input_dir, "ImageSetsCityColorLabelNoAug")
    ...
    args.label_name = "city_color_label"
    args.bool_aug = True
    args.to_input_dir = os.path.join(args.input_dir, "ImageSetsCityColorLabel")
