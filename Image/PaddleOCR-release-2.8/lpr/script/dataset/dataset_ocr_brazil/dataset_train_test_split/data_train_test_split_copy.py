...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir', type=str, default="/yuanhuan/data/image/LicensePlate_ocr/training/plate_brazil/data_crop_2022_0914/") 
    args = parser.parse_args()

    print("3、data train test split copy.")
    print("input_dir: {}".format(args.input_dir))

    args.copy_from_trainval_file = os.path.join(args.input_dir,  "ImageSets/Main/trainval.txt")
    args.copy_from_train_file = os.path.join(args.input_dir,  "ImageSets/Main/train.txt")
    args.copy_from_val_file = os.path.join(args.input_dir,  "ImageSets/Main/val.txt")
    args.copy_from_test_file = os.path.join(args.input_dir,  "ImageSets/Main/test.txt")

    args.to_img_dir = os.path.join(args.input_dir, "Images_aug")
