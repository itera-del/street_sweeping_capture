...
class SSDDetector(object):
    def __init__(self, num_classes=3, device="cpu", weight_path="/home/workspace/xnlin/pytorch/china_plates/plate_regression/ssd_detector/SSD_VGG_FPN_VOC_epoches_165.pth"):
    ...
    def detect(self, img, thresh=0.5, with_score=False):
        ...
        h, w, _ = img.shape
        out_dict = {}
        for k in range(1, len(VOC_CLASSES)):
            box_locations = []
            ...
            out_dict[VOC_CLASSES[k]] = box_locations
        # else:
        #     box_scores = None
        #     box_locations = None
