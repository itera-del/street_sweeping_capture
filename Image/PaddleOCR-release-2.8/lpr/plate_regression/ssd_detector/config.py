...
class Config(object):
    def __init__(self):
        self.folder_name = "MobileNetSmallV1_PO_singapore_Wdm"
        self.img_mean = 127.5
        ...
        self.train_set_mat_file = "/home/workspace/jhwen/data/plate_data/singapore/train_crop.mat"
        self.validation_set_mat_file = "/home/workspace/jhwen/data/plate_data/singapore/val_crop.mat"
        self.log_flag = True
        self.print_freq = 5
        self.epochs = 60
