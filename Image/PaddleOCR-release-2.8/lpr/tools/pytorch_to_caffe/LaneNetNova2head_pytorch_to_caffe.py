...
if __name__ == '__main__':
    ...
    weight_map = [
        ...
        ('deconv4.0', 'decon6_0_0'),
        ('deconv4.1', 'bn6_0_0'),
        ('deconv4.1', 'scale6_0_0'),        
        ('deconv5.0', 'decon7_0_0'),
        ('deconv5.1', 'bn7_0_0'),
        ('deconv5.1', 'scale7_0_0'),
        ('deconv6.0', 'decon7_0_1'),
    ]

    pytorch_net = torch.load("/mnt/huanyuan/model/image/lpr/zd/seg_city_color_zd_1104/LaneNetNova2Head.pth", map_location='cpu')['net']
    save_path = '/mnt/huanyuan/model/image/lpr/zd/seg_city_color_zd_1104/LaneNetNova_seg_city_color_zd_1104.caffemodel'
    net = caffe.Net('./tools/prototxt/LaneNetNova2Head_class_15.prototxt', caffe.TEST)
