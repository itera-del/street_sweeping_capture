...
if __name__ == '__main__':
    ...
    # pytorch_net = torch.load("./output/island/LaneNetNova.pth", map_location='cpu')['net']
    # save_path = './tools/island.caffemodel'
    # net = caffe.Net('./tools/deploy_island.prototxt', caffe.TEST)
    
    # pytorch_net = torch.load("./output/seg_city/LaneNetNova.pth", map_location='cpu')['net']
    # save_path = './tools/LaneNetNova_seg_city.caffemodel'
    pytorch_net = torch.load("/mnt/huanyuan/model/image/lpr/zd/seg_city_cartype_kind_num_zd_1019/LaneNetNova.pth", map_location='cpu')['net']
    save_path = '/mnt/huanyuan/model/image/lpr/zd/seg_city_cartype_kind_num_zd_1019/LaneNetNova_seg_city_cartype_kind_num_zd_1019.caffemodel'
    net = caffe.Net('./tools/prototxt/LaneNetNova_class_15.prototxt', caffe.TEST)
