...
font2 = ImageFont.truetype("font/Dubai-Medium.otf", 120, 0)
...
def gen_plates_single(N, path='imgs'):
    ...
    for i in range(N):
        ...
        ImageDraw.Draw(board).text((org1, -10), s[0], (pixel1,pixel1,pixel1), font=font1)
        ImageDraw.Draw(board).text((org1+2, -6), s[0],(pixel255,pixel255,pixel255), font=font1_)
        ImageDraw.Draw(board).text((org2, -20), s[1], (pixel0,pixel0,pixel0), font=font2)
...
if __name__ == '__main__':
    ...
    BOARD = cv2.imread('src_board/plate_single.png')
    gen_plates_single(2000, 'imgs_single')
