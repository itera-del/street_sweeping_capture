...
from infer.lpr import LPRCaffe, ocr_labels_cn
...
def model_test(args):
    ...
    for idx in tqdm(range(len(img_list))):
        ...
        results_dict['label'] = "".join( ocr_labels_cn[int(idx) + 1] for idx in str(img_list[idx]).split('-')[1].split('.')[0].split('_'))
...
def main():
    ...
    # test
    args.img_dir = "/mnt/huanyuan/temp/plate_cn/test/Y2/"
    args.output_csv_path = "/mnt/huanyuan/model_final/image_model/lpr_zg/china/double/Y2.csv"
    model_test(args)
