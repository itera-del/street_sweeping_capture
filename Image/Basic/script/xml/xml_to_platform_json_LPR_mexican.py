            ...
            if args.add_license_attribute:
                if classname == "license":
                    ...
                    if args.with_color:
                        ...
                        if license_plate_ocr == "123456789":
                            bndbox.extend([[{"name": "number", "value": ""}, {"name": "color", "value": "white"}, {"name": "column", "value": "single"}, {"name": "status", "value": "n"}]])
                        else:
                            bndbox.extend([[{"name": "number", "value": license_plate_ocr}, {"name": "color", "value": "white"}, {"name": "column", "value": "single"}, {"name": "status", "value": "n"}]])
                    else:
                        license_plate_ocr = classname.split('license_')[1]
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--input_dir",
        type=str,
        default="/yuanhuan/data/mhr/dataset_closed_loop/frames/mexican/Mexican_20260331_frames_5f",
    )
    parser.add_argument(
        "--meta_template_path",
        type=str,
    ...
    parser.add_argument("--jpg_name", type=str, default="JPEGImages1/")
    parser.add_argument("--xml_name", type=str, default="Annotations1/")
