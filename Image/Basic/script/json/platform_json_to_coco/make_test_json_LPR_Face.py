...
# 备忘
# 原数据标签
# det_all=['front_face', 'side_face', 'face_occlusion', 'person', 'bicyclist', 'motorcyclist']
det_all=['car', 'bus', 'truck', 'motorcyclist', 'license', 'front_face', 'side_face', 'person', 'bicyclist']
seg_all=['none']
...
if __name__ == '__main__':
    dataroot = '/yuanhuan/data/image/RM_Capture/training/Capture_Plate_Face_2w_Plate_Balanced_selection_c27_1w_Face_1w/Balanced_selection/3w_add_1w_face'
    save_root = dataroot
