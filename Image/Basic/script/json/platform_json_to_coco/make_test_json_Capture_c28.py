...
det_all=['bicyclist', 'motorcyclist', 'person']
seg_all=['none']
det_dict = {
    'car': 'car', 
    'bus': 'car', 
...
if __name__ == '__main__':
    # dataroot = '/yuanhuan/data/image/RM_Capture/training/Capture_C28_bicyclist_motorcyclist'
    # save_root= '/yuanhuan/data/image/RM_Capture/training/Capture_C28_bicyclist_motorcyclist'
    dataroot = '/yuanhuan/data/image/RM_Capture/training/Capture_BSD_R151_bicyclist_motorcyclist'
    save_root= '/yuanhuan/data/image/RM_Capture/training/Capture_BSD_R151_bicyclist_motorcyclist'
    
    ori_jpg_name = "JPEGImages_trainval_cyclist"
    ori_json_name = "Jsons_cyclist"
    to_json_name = "train.json"
    
    # ori_jpg_name = "JPEGImages_test_cyclist"
    # ori_json_name = "Jsons_cyclist"
