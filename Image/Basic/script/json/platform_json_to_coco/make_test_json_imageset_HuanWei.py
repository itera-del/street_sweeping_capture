...
if __name__ == '__main__':
    dataroot = '/yuanhuan/data/image/RM_HUANWEI/original/Argentina/Argentina/Argentina_20250910_有编号有垃圾桶'
    save_root= '/yuanhuan/data/image/RM_HUANWEI/original/Argentina/Argentina/Argentina_20250910_有编号有垃圾桶'
