...
def json_xml(args):
    ...
    for idx in tqdm(range(len(json_list))):
        ...
        for track in annotation['shapes']:
            ...
            x2 = min(int(points[2]), img_width) 
            y2 = min(int(points[3]), img_height)
...
if __name__ == '__main__':
    ...
    #args.jpg_dir = "/yuanhuan/data/image/RM_HUANWEI/original/Argentina/Argentina/Argentina_20240913/JPEGImages/"
    #args.json_dir = "/yuanhuan/data/image/RM_HUANWEI/original/Argentina/Argentina/Argentina_20240913/Jsons/"
    #args.xml_dir = "/yuanhuan/data/image/RM_HUANWEI/original/Argentina/Argentina/Argentina_20240913/Annotations/"

    #人头检测
    args.jpg_dir = "/yuanhuan/chenxiao/人头标注数据/images/"
    args.json_dir = "/yuanhuan/chenxiao/人头标注数据/json_v0/"
    args.xml_dir = "/yuanhuan/chenxiao/人头标注数据/xml/"
