...
def load_objectinfo():
    ...
    objectinfo['plate_info']['city_roi'] = []
    objectinfo['plate_info']['kind'] = ''
    objectinfo['plate_info']['num'] = ''
    objectinfo['plate_info']['kind_stabel'] = ''
    objectinfo['plate_info']['num_stabel'] = ''
    objectinfo['plate_info']['city_stabel'] = ''
    ...
    # person_info
    objectinfo['person_info'] = {}
    objectinfo['person_info']['roi'] = []
    objectinfo['person_info']['attri'] = 'none'
    objectinfo['person_info']['detect_score'] = 0.0
    ...
    objectinfo['state']['car_attri_list'] = []                              # 车辆类型识别结果得分（多帧）
