...
# options.yolov6_checkpoint = "/mnt/huanyuan/model/image/yolov6/yolov6_c27_car_bus_truck_moto_plate_0731/epoch_260_deploy.pth"
# options.yolov6_class_name = ["car", "bus", "truck", "motorcyclist", "license_plate"]
# options.yolov6_threshold_list = [0.3, 0.3, 0.3, 0.3, 0.3]

# # yolov6_rm_capture_90w_512_288
# options.yolov6_config = "/mnt/huanyuan/model/image/yolov6/yolov6_rm_capture_90w_512_288/yolov6_rm_capture_deploy.py"
# options.yolov6_checkpoint = "/mnt/huanyuan/model/image/yolov6/yolov6_rm_capture_90w_512_288/epoch_300_deploy.pth"
# options.yolov6_class_name = ["car", "bus", "truck", "motorcyclist", "license_plate"]
...
# # yolov6_rm_capture_190w_512_288
# options.yolov6_config = "/mnt/huanyuan/model/image/yolov6/yolov6_rm_capture_190w_512_288/yolov6_rm_capture_deploy.py"
# options.yolov6_checkpoint = "/mnt/huanyuan/model/image/yolov6/yolov6_rm_capture_190w_512_288/epoch_80_deploy.pth"
# options.yolov6_class_name = ["car", "bus", "truck", "motorcyclist", "license_plate"]
# options.yolov6_threshold_list = [0.4, 0.4, 0.4, 0.4, 0.4]
...
# options.china.ocr_onnx_model_path = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_en_number_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20230530_cn/inference/onnx/model.onnx"
...
# paddle_ocr_20230727_cn_diffste_1_7M
options.lpr_paddle_bool = True
options.china.ocr_pth_path = ""
options.china.ocr_caffe_prototxt = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_chn_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20230727_diffste_1_7M/inference_iter_epoch_175/caffe/model.prototxt"
options.china.ocr_caffe_model_path = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_chn_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20230727_diffste_1_7M/inference_iter_epoch_175/caffe/model.caffemodel"
options.china.ocr_onnx_model_path = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_chn_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20230727_diffste_1_7M/inference_iter_epoch_175/onnx/model.onnx"
options.china.input_shape = (1, 64, 256)
options.china.ocr_labels_dict_path = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_chn_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20230727_diffste_1_7M/inference_iter_epoch_175/cn_dict.txt"
options.china.ocr_prefix_beam_search_bool = False
options.china.padding_bool = False

# # paddle_ocr_20240625_cn_w_aug_w_fangse_sample
# options.lpr_paddle_bool = True
# options.china.ocr_pth_path = ""
# options.china.ocr_caffe_prototxt = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_chn_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20240625_w_aug_w_fangse_sample/inference_300/caffe/model.prototxt"
# options.china.ocr_caffe_model_path = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_chn_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20240625_w_aug_w_fangse_sample/inference_300/caffe/model.caffemodel"
# options.china.ocr_onnx_model_path = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_chn_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20240625_w_aug_w_fangse_sample/inference_300/onnx/model.onnx"
# options.china.input_shape = (1, 64, 256)
# options.china.ocr_labels_dict_path = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_chn_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20240625_w_aug_w_fangse_sample/inference_300/cn_dict.txt"
# options.china.ocr_prefix_beam_search_bool = False
# options.china.padding_bool = False
...
# options.lpr_paddle_bool = True
# options.china.ocr_pth_path = ""
# options.china.ocr_caffe_prototxt = "/yuanhuan/model/image/lpr/paddle_ocr/v1_chn_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20240725_w_aug_w_diffste/inference_300/caffe/model.prototxt"
# options.china.ocr_caffe_model_path = "/yuanhuan/model/image/lpr/paddle_ocr/v1_chn_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20240725_w_aug_w_diffste/inference_300/caffe/model.caffemodel"
# options.china.ocr_onnx_model_path = "/yuanhuan/model/image/lpr/paddle_ocr/v1_chn_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20240725_w_aug_w_diffste/inference_300/onnx/model.onnx"
# options.china.input_shape = (1, 64, 256)
# options.china.ocr_labels_dict_path = "/yuanhuan/model/image/lpr/paddle_ocr/v1_chn_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20240725_w_aug_w_diffste/inference_300/cn_dict.txt"
# options.china.ocr_prefix_beam_search_bool = False
# options.china.padding_bool = False
...
options.china.seg_caffe_prototxt = "/yuanhuan/model/image/lpr/cn/seg_color_cn_20230530/seg_color_cn_20230530.prototxt"
options.china.seg_caffe_model_path = "/yuanhuan/model/image/lpr/cn/seg_color_cn_20230530/seg_color_cn_20230530.caffemodel"
...
# 车牌长宽阈值
# options.plate_height = [30, 250]  # zg chn 500W
# options.plate_width = [65, 500]
# options.plate_height = [25, 250]  # zg chn 1080P
# options.plate_width = [55, 500]
options.plate_height = [35, 250]  # sz taxi chn 1080P
options.plate_width = [80, 500]
