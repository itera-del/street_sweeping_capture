...
options.eu.ocr_pth_path = ""
options.eu.ocr_caffe_prototxt = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_eu_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20240321_w_diffste_w_aug/inference/caffe/model.prototxt"
options.eu.ocr_caffe_model_path = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_eu_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20240321_w_diffste_w_aug/inference/caffe/model.caffemodel"
options.eu.ocr_onnx_model_path = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_eu_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20240321_w_diffste_w_aug/inference/onnx/model.onnx"
options.eu.input_shape = (1, 64, 256)
options.eu.ocr_labels_dict_path = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_eu_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20240321_w_diffste_w_aug/inference/eu_dict.txt"
options.eu.ocr_prefix_beam_search_bool = False
options.eu.padding_bool = False
options.eu.ocr_labels = [' ', '1', '2', '3', '4', '5', '6', '7', '8', '9', '0', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I',
