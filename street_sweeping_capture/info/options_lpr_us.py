...
options.us.ocr_pth_path = ""
# options.us.ocr_caffe_prototxt = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_us_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_128_256_202310_w_diffste_w_aug/inference/caffe/model.prototxt"
# options.us.ocr_caffe_model_path = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_us_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_128_256_202310_w_diffste_w_aug/inference/caffe/model.caffemodel"
# options.us.ocr_onnx_model_path = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_us_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_128_256_202310_w_diffste_w_aug/inference/onnx/model.onnx"
options.us.ocr_caffe_prototxt = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_us_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_128_256_202406_ALL_US/inference/caffe/model.prototxt"
options.us.ocr_caffe_model_path = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_us_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_128_256_202406_ALL_US/inference/caffe/model.caffemodel"
options.us.ocr_onnx_model_path = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_us_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_128_256_202406_ALL_US/inference/onnx/model.onnx"
options.us.input_shape = (1, 128, 256)
options.us.ocr_labels_dict_path = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_us_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_128_256_202406_ALL_US/inference/us_dict.txt"
options.us.ocr_prefix_beam_search_bool = False
options.us.padding_bool = False

options.us.ocr_labels = ['-', '1', '2', '3', '4', '5', '6', '7', '8', '9', '0', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I',
                                'J', 'K', 'L', 'M', 'N', 'P', 'O', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z','#']
options.us.ocr_prefix_beam_search_bool = False
options.us.padding_bool = False

# 车牌长宽阈值
# options.plate_height = [45, 960]
# options.plate_width = [0, 1920]
options.plate_height = [60, 960]
options.plate_width = [0, 1920]
