...
options.chile.ocr_pth_path = ""
options.chile.ocr_caffe_prototxt = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_chile_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_128_256_202312_w_diffste_w_aug/inference/caffe/model.prototxt"
options.chile.ocr_caffe_model_path = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_chile_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_128_256_202312_w_diffste_w_aug/inference/caffe/model.caffemodel"
options.chile.ocr_onnx_model_path = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_chile_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_128_256_202312_w_diffste_w_aug/inference/onnx/model.onnx"
options.chile.input_shape = (1, 128, 256)
options.chile.ocr_labels_dict_path = "/mnt/huanyuan/model/image/lpr/paddle_ocr/v1_chile_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_128_256_202312_w_diffste_w_aug/inference/chile_dict.txt"
options.chile.ocr_prefix_beam_search_bool = False
options.chile.padding_bool = False

options.chile.ocr_labels = ['-', '1', '2', '3', '4', '5', '6', '7', '8', '9', '0', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I',
...
options.plate_height = [30, 960]    # 720P
options.plate_width = [0, 1920]
...
###########################################
# 抓拍线
options.capture_line_up_down_ratio = [0.03, 0.35, 0.9, 0.97]
